                                            ...
                                            wxWindowID WXUNUSED (id))
{
  ...
  Create (parent, wxID_ANY, _ ("MathPlot Configuration"), wxDefaultPosition,
          wxDefaultSize, wxSTAY_ON_TOP | wxDEFAULT_DIALOG_STYLE,
          _T("wxID_ANY"));
  sizerMain = new wxBoxSizer (wxVERTICAL);
  nbConfig
    = new wxNotebook (this, wxID_ANY, wxDefaultPosition, wxDefaultSize, 0);
  Panel1 = new wxPanel (nbConfig, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL);
  BoxSizer3 = new wxBoxSizer (wxVERTICAL);
  StaticBoxSizer1 = new wxStaticBoxSizer (wxVERTICAL, Panel1, _ ("Title "));
  FlexGridSizer1 = new wxFlexGridSizer (2, 3, 0, 0);
  FlexGridSizer1->AddGrowableCol (1);
  StaticText11 = new wxStaticText (Panel1, wxID_ANY, _ ("Title :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer1->Add (StaticText11, 0,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  edTitle = new wxTextCtrl (Panel1, wxID_ANY, wxEmptyString, wxDefaultPosition,
                            wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer1->Add (edTitle, 1, wxALL | wxEXPAND, 5);
  bFontTitle = new wxButton (Panel1, wxID_ANY, _ ("Font"), wxDefaultPosition,
                             wxSize (64, -1), 0, wxDefaultValidator);
  bFontTitle->Disable ();
  FlexGridSizer1->Add (bFontTitle, 0,
                       wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  cbTitleVisible
    = new wxCheckBox (Panel1, wxID_ANY, _ ("Visible"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbTitleVisible->SetValue (false);
  FlexGridSizer1->Add (cbTitleVisible, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  StaticText15 = new wxStaticText (Panel1, wxID_ANY, _ ("Margins :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer2->Add (StaticText15, 0,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  edMarginTop = new wxTextCtrl (Panel1, wxID_ANY, _T("50"), wxDefaultPosition,
                                wxSize (40, -1), wxTE_RIGHT,
                                wxIntegerValidator<unsigned int> (&int_top));
  edMarginTop->SetToolTip (_ ("Top"));
  FlexGridSizer2->Add (
    edMarginTop, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 2);
  edMarginBottom = new wxTextCtrl (
    Panel1, wxID_ANY, _T("50"), wxDefaultPosition, wxSize (40, -1), wxTE_RIGHT,
    wxIntegerValidator<unsigned int> (&int_bottom));
  edMarginBottom->SetToolTip (_ ("Bottom"));
  FlexGridSizer2->Add (
    edMarginBottom, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 2);
  edMarginLeft = new wxTextCtrl (Panel1, wxID_ANY, _T("50"), wxDefaultPosition,
                                 wxSize (40, -1), wxTE_RIGHT,
                                 wxIntegerValidator<unsigned int> (&int_left));
  edMarginLeft->SetToolTip (_ ("Left"));
  FlexGridSizer2->Add (
    edMarginLeft, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 2);
  edMarginRight = new wxTextCtrl (
    Panel1, wxID_ANY, _T("50"), wxDefaultPosition, wxSize (40, -1), wxTE_RIGHT,
    wxIntegerValidator<unsigned int> (&int_right));
  edMarginRight->SetToolTip (_ ("Right"));
  FlexGridSizer2->Add (
    edMarginRight, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 2);
  bBGColor = new wxButton (Panel1, wxID_ANY, _ ("bg color"), wxDefaultPosition,
                           wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer2->Add (
    bBGColor, 0, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  cbDrawBox
    = new wxCheckBox (Panel1, wxID_ANY, _ ("Draw box"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  ...
  StaticBoxSizer3
    = new wxStaticBoxSizer (wxHORIZONTAL, Panel1, _ ("Mouse coordinates "));
  BoxSizer1 = new wxBoxSizer (wxVERTICAL);
  BoxSizer12 = new wxBoxSizer (wxHORIZONTAL);
  StaticText18 = new wxStaticText (Panel1, wxID_ANY, _ ("Position :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  BoxSizer12->Add (StaticText18, 0,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  const wxString cbCoord_choices[] = {
    _ ("Left center"),     _ ("Top left"),     _ ("Top center"),
    _ ("Top right"),       _ ("Right center"), _ ("Bottom left"),
    _ ("Bottom center"),   _ ("Bottom right"), _ ("Default position"),
    _ ("Cursor position"),
  };
  cbCoord = new wxChoice (Panel1, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                          10, cbCoord_choices, 0, wxDefaultValidator);
  cbCoord->SetSelection (0);
  cbCoord->Set (WXSIZEOF (cbCoord_choices), cbCoord_choices);
  cbCoord->SetSelection (0);
  BoxSizer12->Add (cbCoord, 1,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  BoxSizer1->Add (BoxSizer12, 0,
                  wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                  0);
  cbCoordVisible
    = new wxCheckBox (Panel1, wxID_ANY, _ ("Visible"), wxDefaultPosition,
  ...
  cbCoordOutside
    = new wxCheckBox (Panel1, wxID_ANY, _ ("Coordinates in Margins"),
                      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
  cbCoordOutside->SetValue (false);
  cbCoordOutside->SetToolTip (
    _ ("Shows the coordinates when the mouse is in the margins"));
  BoxSizer1->Add (cbCoordOutside, 0, wxBOTTOM | wxLEFT | wxRIGHT | wxEXPAND,
                  5);
  cbCoordinates
    = new wxCheckBox (Panel1, wxID_ANY, _ ("Series coordinates"),
                      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
  cbCoordinates->SetValue (false);
  cbCoordinates->SetToolTip (
    _ ("Shows the coordinates of the series closest to the mouse position"));
  BoxSizer1->Add (cbCoordinates, 0, wxBOTTOM | wxLEFT | wxRIGHT | wxEXPAND, 5);
  cbMagnetize
    = new wxCheckBox (Panel1, wxID_ANY, _ ("Magnetize"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbMagnetize->SetValue (false);
  BoxSizer1->Add (cbMagnetize, 0, wxBOTTOM | wxLEFT | wxRIGHT | wxEXPAND, 5);
  StaticBoxSizer3->Add (
    BoxSizer1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  StaticBoxSizer4 = new wxStaticBoxSizer (wxHORIZONTAL, Panel1, _ ("Brush "));
  FlexGridSizer4 = new wxFlexGridSizer (2, 2, 0, 0);
  StaticText22 = new wxStaticText (Panel1, wxID_ANY, _ ("Color :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer4->Add (StaticText22, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  bCoordBrushColor
    = new wxButton (Panel1, wxID_ANY, wxEmptyString, wxDefaultPosition,
                    wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer4->Add (bCoordBrushColor, 1, wxALL | wxEXPAND, 2);
  StaticText23 = new wxStaticText (Panel1, wxID_ANY, _ ("Style :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer4->Add (StaticText23, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  cbCoordBrushStyle
    = new wxChoice (Panel1, wxID_ANY, wxDefaultPosition, wxDefaultSize, 2,
                    cbCoordBrushStyle_choices, 0, wxDefaultValidator);
  ...
  Panel2 = new wxPanel (nbConfig, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL);
  BoxSizer16 = new wxBoxSizer (wxHORIZONTAL);
  FlexGridSizer6 = new wxFlexGridSizer (4, 2, 0, 0);
  StaticText16 = new wxStaticText (Panel2, wxID_ANY, _ ("Position :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer6->Add (StaticText16, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  cbLegendPosition
    = new wxChoice (Panel2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 9,
                    cbLegendPosition_choices, 0, wxDefaultValidator);
  cbLegendPosition->SetSelection (0);
  FlexGridSizer6->Add (cbLegendPosition, 1, wxALL | wxEXPAND, 2);
  StaticText24 = new wxStaticText (Panel2, wxID_ANY, _ ("Style :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer6->Add (StaticText24, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  cbLegendStyle
    = new wxChoice (Panel2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 2,
                    cbLegendStyle_choices, 0, wxDefaultValidator);
  cbLegendStyle->SetSelection (0);
  FlexGridSizer6->Add (cbLegendStyle, 1, wxALL | wxEXPAND, 2);
  StaticText25 = new wxStaticText (Panel2, wxID_ANY, _ ("Direction :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer6->Add (StaticText25, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  cbLegendDirection
    = new wxChoice (Panel2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 2,
                    cbLegendDirection_choices, 0, wxDefaultValidator);
  cbLegendDirection->SetSelection (0);
  FlexGridSizer6->Add (cbLegendDirection, 1, wxALL | wxEXPAND, 2);
  cbLegendVisible
    = new wxCheckBox (Panel2, wxID_ANY, _ ("Visible"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbLegendVisible->SetValue (false);
  FlexGridSizer6->Add (cbLegendVisible, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  BoxSizer16->Add (FlexGridSizer6, 1, wxALL | wxALIGN_TOP, 5);
  BoxSizer15 = new wxBoxSizer (wxVERTICAL);
  bFontLegend = new wxButton (Panel2, wxID_ANY, _ ("Font"), wxDefaultPosition,
                              wxDefaultSize, 0, wxDefaultValidator);
  bFontLegend->Disable ();
  ...
  StaticText20 = new wxStaticText (Panel2, wxID_ANY, _ ("Color :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer7->Add (StaticText20, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  bLegendBrushColor
    = new wxButton (Panel2, wxID_ANY, wxEmptyString, wxDefaultPosition,
                    wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer7->Add (bLegendBrushColor, 1, wxALL | wxEXPAND, 2);
  StaticText21 = new wxStaticText (Panel2, wxID_ANY, _ ("Style :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer7->Add (StaticText21, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  cbLegendBrushStyle
    = new wxChoice (Panel2, wxID_ANY, wxDefaultPosition, wxDefaultSize, 2,
                    cbLegendBrushStyle_choices, 0, wxDefaultValidator);
  ...
  Panel3 = new wxPanel (nbConfig, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL);
  sizerAxis = new wxBoxSizer (wxVERTICAL);
  FlexGridSizer3 = new wxFlexGridSizer (1, 3, 0, 0);
  FlexGridSizer3->AddGrowableCol (0);
  ChoiceAxis = new wxChoice (Panel3, wxID_ANY, wxDefaultPosition,
                             wxDefaultSize, 0, 0, 0, wxDefaultValidator);
  FlexGridSizer3->Add (ChoiceAxis, 1, wxALL | wxEXPAND, 5);
  bAddXAxis
    = new wxButton (Panel3, wxID_ANY, _ ("Add X axis"), wxDefaultPosition,
                    wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer3->Add (
    bAddXAxis, 0, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  bAddYAxis
    = new wxButton (Panel3, wxID_ANY, _ ("Add Y axis"), wxDefaultPosition,
                    wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer3->Add (
    bAddYAxis, 0, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  sizerAxis->Add (FlexGridSizer3, 0, wxALL | wxEXPAND, 2);
  FlexGridSizer8 = new wxFlexGridSizer (1, 3, 0, 0);
  FlexGridSizer8->AddGrowableCol (1);
  StaticText8 = new wxStaticText (Panel3, wxID_ANY, _ ("Name :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer8->Add (StaticText8, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  edAxisName
    = new wxTextCtrl (Panel3, wxID_ANY, wxEmptyString, wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer8->Add (edAxisName, 0, wxALL | wxEXPAND, 5);
  bFontAxis = new wxButton (Panel3, wxID_ANY, _ ("Font"), wxDefaultPosition,
                            wxSize (64, -1), 0, wxDefaultValidator);
  bFontAxis->Disable ();
  FlexGridSizer8->Add (
    bFontAxis, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  ...
  StaticText12 = new wxStaticText (Panel3, wxID_ANY, _ ("Color :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer10->Add (StaticText12, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  bAxisPenColor
    = new wxButton (Panel3, wxID_ANY, wxEmptyString, wxDefaultPosition,
                    wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer10->Add (bAxisPenColor, 1, wxALL | wxEXPAND, 2);
  StaticText13 = new wxStaticText (Panel3, wxID_ANY, _ ("Width :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer10->Add (StaticText13, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  cbAxisPenWidth
    = new wxChoice (Panel3, wxID_ANY, wxDefaultPosition, wxDefaultSize, 10,
                    cbAxisPenWidth_choices, 0, wxDefaultValidator);
  cbAxisPenWidth->SetSelection (0);
  FlexGridSizer10->Add (cbAxisPenWidth, 1, wxALL | wxEXPAND, 2);
  StaticText14 = new wxStaticText (Panel3, wxID_ANY, _ ("Style :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer10->Add (StaticText14, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  const wxString cbAxisPenStyle_choices[] = {
    _ ("Solid"), _ ("Dot"), _ ("Long Dash"), _ ("Short Dash"), _ ("Dot Dash"),
  };
  cbAxisPenStyle
    = new wxChoice (Panel3, wxID_ANY, wxDefaultPosition, wxDefaultSize, 5,
                    cbAxisPenStyle_choices, 0, wxDefaultValidator);
  cbAxisPenStyle->SetSelection (0);
  FlexGridSizer10->Add (cbAxisPenStyle, 1, wxALL | wxEXPAND, 2);
  StaticBoxSizer6->Add (
    FlexGridSizer10, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  BoxSizer7->Add (StaticBoxSizer6, 0,
                  wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                  2);
  StaticBoxSizer7 = new wxStaticBoxSizer (wxHORIZONTAL, Panel3, _ ("Scale "));
  FlexGridSizer12 = new wxFlexGridSizer (3, 2, 0, 0);
  cbAutoScale
    = new wxCheckBox (Panel3, wxID_ANY, _ ("Auto"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbAutoScale->SetValue (true);
  FlexGridSizer12->Add (cbAutoScale, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  FlexGridSizer12->Add (
    -1, -1, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText27 = new wxStaticText (Panel3, wxID_ANY, _ ("Min :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer12->Add (StaticText27, 1,
                        wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edScaleMin = new wxTextCtrl (
    Panel3, wxID_ANY, _T("-1"), wxDefaultPosition, wxSize (64, -1), wxTE_RIGHT,
    wxFloatingPointValidator<double> (2, &scale_min));
  edScaleMin->Disable ();
  FlexGridSizer12->Add (
    edScaleMin, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    2);
  StaticText28 = new wxStaticText (Panel3, wxID_ANY, _ ("Max :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer12->Add (StaticText28, 1,
                        wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
  edScaleMax = new wxTextCtrl (
    Panel3, wxID_ANY, _T("1"), wxDefaultPosition, wxSize (64, -1), wxTE_RIGHT,
    wxFloatingPointValidator<double> (2, &scale_max));
  edScaleMax->Disable ();
  FlexGridSizer12->Add (
    edScaleMax, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    2);
  StaticBoxSizer7->Add (
    FlexGridSizer12, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  BoxSizer7->Add (StaticBoxSizer7, 0, wxALL | wxEXPAND, 2);
  BoxSizer6->Add (BoxSizer7, 0,
                  wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                  2);
  BoxSizer5 = new wxBoxSizer (wxVERTICAL);
  BoxSizer13 = new wxBoxSizer (wxHORIZONTAL);
  StaticText17 = new wxStaticText (Panel3, wxID_ANY, _ ("Position :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  BoxSizer13->Add (StaticText17, 0,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  cbAxisPosition = new wxChoice (Panel3, wxID_ANY, wxDefaultPosition,
                                 wxDefaultSize, 0, 0, 0, wxDefaultValidator);
  BoxSizer13->Add (cbAxisPosition, 1,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  BoxSizer5->Add (BoxSizer13, 0, wxALL | wxALIGN_LEFT, 0);
  cbAxisVisible
    = new wxCheckBox (Panel3, wxID_ANY, _ ("Visible"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbAxisVisible->SetValue (false);
  BoxSizer5->Add (cbAxisVisible, 0, wxALL | wxALIGN_LEFT, 5);
  cbGridVisible
    = new wxCheckBox (Panel3, wxID_ANY, _ ("Show grid"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbGridVisible->SetValue (false);
  BoxSizer5->Add (cbGridVisible, 0, wxALL | wxALIGN_LEFT, 5);
  cbAxisOutside
    = new wxCheckBox (Panel3, wxID_ANY, _ ("Draw Outside Margins"),
                      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
  cbAxisOutside->SetValue (false);
  BoxSizer5->Add (cbAxisOutside, 0, wxALL | wxALIGN_LEFT, 5);
  BoxSizer14 = new wxBoxSizer (wxHORIZONTAL);
  StaticText29 = new wxStaticText (Panel3, wxID_ANY, _ ("Format :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  BoxSizer14->Add (StaticText29, 0,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  const wxString cbFormat_choices[] = {
    _ ("Normal"),   _ ("Time"), _ ("Hours"), _ ("Date"),
    _ ("DateTime"), _ ("User"), _ ("None"),
  };
  cbFormat = new wxChoice (Panel3, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                           7, cbFormat_choices, 0, wxDefaultValidator);
  cbFormat->SetSelection (0);
  cbFormat->Set (WXSIZEOF (cbFormat_choices), cbFormat_choices);
  cbFormat->SetSelection (0);
  BoxSizer14->Add (cbFormat, 1,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  BoxSizer5->Add (BoxSizer14, 0, wxALL | wxALIGN_LEFT, 0);
  FlexGridSizer11 = new wxFlexGridSizer (1, 2, 0, 0);
  StaticText26 = new wxStaticText (Panel3, wxID_ANY, _ ("User Label Format :"),
                                   wxPoint (192, 200), wxDefaultSize, 0);
  FlexGridSizer11->Add (
    StaticText26, 1,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  edFormat
    = new wxTextCtrl (Panel3, wxID_ANY, wxEmptyString, wxDefaultPosition,
                      wxSize (60, -1), 0, wxDefaultValidator);
  edFormat->Disable ();
  edFormat->SetToolTip (
    _ ("Format of the label for the axis. Should be like c++ format."));
  FlexGridSizer11->Add (
    edFormat, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  BoxSizer5->Add (FlexGridSizer11, 1, wxALL | wxALIGN_LEFT, 0);
  cbLogAxis
    = new wxCheckBox (Panel3, wxID_ANY, _ ("Logarithmic axis"),
                      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
  cbLogAxis->SetValue (false);
  BoxSizer5->Add (cbLogAxis, 0, wxALL | wxALIGN_LEFT, 5);
  cbIsY2Axis
    = new wxCheckBox (Panel3, wxID_ANY, _ ("Is Y2 axis"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  ...
  Panel4 = new wxPanel (nbConfig, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL);
  BoxSizer8 = new wxBoxSizer (wxVERTICAL);
  FlexGridSizer13 = new wxFlexGridSizer (1, 3, 0, 0);
  FlexGridSizer13->AddGrowableCol (1);
  StaticText1 = new wxStaticText (Panel4, wxID_ANY, _ ("Series name :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer13->Add (StaticText1, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ChoiceSeries = new wxChoice (Panel4, wxID_ANY, wxDefaultPosition,
                               wxDefaultSize, 0, 0, 0, wxDefaultValidator);
  FlexGridSizer13->Add (ChoiceSeries, 1, wxALL | wxEXPAND, 5);
  bDelSeries = new wxButton (Panel4, wxID_ANY, _ ("Delete"), wxDefaultPosition,
                             wxDefaultSize, 0, wxDefaultValidator);
  bDelSeries->Disable ();
  FlexGridSizer13->Add (
    bDelSeries, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  ...
  StaticText2 = new wxStaticText (Panel4, wxID_ANY, _ ("Name :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer14->Add (StaticText2, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  edSeriesName
    = new wxTextCtrl (Panel4, wxID_ANY, wxEmptyString, wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  ...
  StaticText3 = new wxStaticText (Panel4, wxID_ANY, _ ("Color :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer17->Add (StaticText3, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  bSeriesPenColor
    = new wxButton (Panel4, wxID_ANY, wxEmptyString, wxDefaultPosition,
                    wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer17->Add (bSeriesPenColor, 1, wxALL | wxEXPAND, 2);
  StaticText4 = new wxStaticText (Panel4, wxID_ANY, _ ("Width :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer17->Add (StaticText4, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  cbSeriesPenWidth
    = new wxChoice (Panel4, wxID_ANY, wxDefaultPosition, wxDefaultSize, 10,
                    cbSeriesPenWidth_choices, 0, wxDefaultValidator);
  cbSeriesPenWidth->SetSelection (0);
  FlexGridSizer17->Add (cbSeriesPenWidth, 1, wxALL | wxEXPAND, 2);
  StaticText5 = new wxStaticText (Panel4, wxID_ANY, _ ("Style :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer17->Add (StaticText5, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  const wxString cbSeriesPenStyle_choices[] = {
    _ ("Solid"), _ ("Dot"), _ ("Long Dash"), _ ("Short Dash"), _ ("Dot Dash"),
  };
  cbSeriesPenStyle
    = new wxChoice (Panel4, wxID_ANY, wxDefaultPosition, wxDefaultSize, 5,
                    cbSeriesPenStyle_choices, 0, wxDefaultValidator);
  ...
  cbSecondYAxis
    = new wxCheckBox (Panel4, wxID_ANY, _ ("Use second Y axis"),
                      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
  ...
  FlexGridSizer15->Add (
    BoxSizer9, 0, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  BoxSizer10 = new wxBoxSizer (wxVERTICAL);
  StaticBoxSizer9 = new wxStaticBoxSizer (wxHORIZONTAL, Panel4, _ ("Brush "));
  FlexGridSizer16 = new wxFlexGridSizer (2, 2, 0, 0);
  StaticText6 = new wxStaticText (Panel4, wxID_ANY, _ ("Color :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer16->Add (StaticText6, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  bSeriesBrushColor
    = new wxButton (Panel4, wxID_ANY, wxEmptyString, wxDefaultPosition,
                    wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer16->Add (bSeriesBrushColor, 1, wxALL | wxEXPAND, 2);
  StaticText7 = new wxStaticText (Panel4, wxID_ANY, _ ("Style :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer16->Add (StaticText7, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  const wxString cbSeriesBrushStyle_choices[] = {
    _ ("Solid"),     _ ("Transparent"), _ ("BDiagonal"),  _ ("CrossDiagonal"),
    _ ("FDiagonal"), _ ("Cross"),       _ ("Horizontal"), _ ("Vertical"),
  };
  cbSeriesBrushStyle
    = new wxChoice (Panel4, wxID_ANY, wxDefaultPosition, wxDefaultSize, 8,
                    cbSeriesBrushStyle_choices, 0, wxDefaultValidator);
  ...
  StaticBoxSizer10
    = new wxStaticBoxSizer (wxHORIZONTAL, Panel4, _ ("Symbol "));
  FlexGridSizer18 = new wxFlexGridSizer (2, 2, 0, 0);
  StaticText9 = new wxStaticText (Panel4, wxID_ANY, _ ("Type :"),
                                  wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer18->Add (StaticText9, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  const wxString cbSeriesSymbolType_choices[] = {
    _ ("None"),         _ ("Circle"), _ ("Square"), _ ("UpTriangle"),
    _ ("DownTriangle"), _ ("Cross"),  _ ("Plus"),
  };
  cbSeriesSymbolType
    = new wxChoice (Panel4, wxID_ANY, wxDefaultPosition, wxDefaultSize, 7,
                    cbSeriesSymbolType_choices, 0, wxDefaultValidator);
  cbSeriesSymbolType->SetSelection (0);
  FlexGridSizer18->Add (cbSeriesSymbolType, 1, wxALL | wxEXPAND, 2);
  StaticText10 = new wxStaticText (Panel4, wxID_ANY, _ ("Size :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer18->Add (StaticText10, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  cbSeriesSymbolSize = new wxSpinCtrl (
    Panel4, wxID_ANY, _T("4"), wxDefaultPosition, wxDefaultSize, 0, 4, 100, 4);
  cbSeriesSymbolSize->SetValue (_T("4"));
  FlexGridSizer18->Add (cbSeriesSymbolSize, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 2);
  StaticBoxSizer10->Add (
    FlexGridSizer18, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  BoxSizer10->Add (StaticBoxSizer10, 0, wxALL, 2);
  FlexGridSizer19 = new wxFlexGridSizer (1, 2, 0, 0);
  StaticText19 = new wxStaticText (Panel4, wxID_ANY, _ ("Skip point over :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer19->Add (StaticText19, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  cbSeriesStep = new wxSpinCtrl (Panel4, wxID_ANY, _T("1"), wxDefaultPosition,
                                 wxDefaultSize, 0, 1, 100, 1);
  cbSeriesStep->SetValue (_T("1"));
  FlexGridSizer19->Add (
    cbSeriesStep, 1,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  BoxSizer10->Add (FlexGridSizer19, 0,
                   wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
                   5);
  cbBar
    = new wxCheckBox (Panel4, wxID_ANY, _ ("View as bar"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbBar->SetValue (false);
  cbBar->Disable ();
  BoxSizer10->Add (cbBar, 1, wxALL | wxEXPAND, 5);
  FlexGridSizer15->Add (BoxSizer10, 1,
                        wxALL | wxALIGN_TOP | wxALIGN_CENTER_HORIZONTAL, 5);
  BoxSizer8->Add (FlexGridSizer15, 0, wxALL | wxEXPAND, 2);
  Panel4->SetSizer (BoxSizer8);
  Panel5 = new wxPanel (nbConfig, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL);
  sizerLines = new wxBoxSizer (wxVERTICAL);
  FlexGridSizer5 = new wxFlexGridSizer (1, 5, 0, 0);
  FlexGridSizer5->AddGrowableCol (0);
  ChoiceLines = new wxChoice (Panel5, wxID_ANY, wxDefaultPosition,
                              wxDefaultSize, 0, 0, 0, wxDefaultValidator);
  FlexGridSizer5->Add (ChoiceLines, 1, wxALL | wxEXPAND, 5);
  bAddLines = new wxButton (Panel5, wxID_ANY, _ ("Add"), wxDefaultPosition,
                            wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer5->Add (bAddLines, 0,
                       wxTOP | wxBOTTOM | wxRIGHT | wxALIGN_CENTER_HORIZONTAL
                         | wxALIGN_CENTER_VERTICAL,
                       5);
  bDelLines = new wxButton (Panel5, wxID_ANY, _ ("Delete"), wxDefaultPosition,
                            wxDefaultSize, 0, wxDefaultValidator);
  bDelLines->Disable ();
  FlexGridSizer5->Add (bDelLines, 0,
                       wxTOP | wxBOTTOM | wxRIGHT | wxALIGN_CENTER_HORIZONTAL
                         | wxALIGN_CENTER_VERTICAL,
                       5);
  sizerLines->Add (FlexGridSizer5, 0, wxALL | wxEXPAND, 2);
  pLines = new wxPanel (Panel5, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                        wxTAB_TRAVERSAL);
  BoxSizer4 = new wxBoxSizer (wxVERTICAL);
  FlexGridSizer9 = new wxFlexGridSizer (2, 4, 0, 0);
  FlexGridSizer9->AddGrowableCol (1);
  StaticText31 = new wxStaticText (pLines, wxID_ANY, _ ("Name :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer9->Add (StaticText31, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  edLinesName
    = new wxTextCtrl (pLines, wxID_ANY, wxEmptyString, wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer9->Add (edLinesName, 1, wxALL | wxEXPAND, 5);
  rbLinesHor
    = new wxRadioButton (pLines, wxID_ANY, _ ("Horizontal"), wxDefaultPosition,
                         wxDefaultSize, 0, wxDefaultValidator);
  rbLinesHor->Disable ();
  FlexGridSizer9->Add (
    rbLinesHor, 0, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  rbLinesVert
    = new wxRadioButton (pLines, wxID_ANY, _ ("Vertical"), wxDefaultPosition,
                         wxDefaultSize, 0, wxDefaultValidator);
  rbLinesVert->Disable ();
  FlexGridSizer9->Add (
    rbLinesVert, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  StaticText30 = new wxStaticText (pLines, wxID_ANY, _ ("Value :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer9->Add (
    StaticText30, 1,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 5);
  edLinesValue = new wxTextCtrl (
    pLines, wxID_ANY, _T("1"), wxDefaultPosition, wxSize (64, -1), wxTE_RIGHT,
    wxFloatingPointValidator<double> (2, &line_value));
  FlexGridSizer9->Add (edLinesValue, 1,
                       wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  StaticText32 = new wxStaticText (pLines, wxID_ANY, _ ("Color :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer21->Add (StaticText32, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  bLinesPenColor
    = new wxButton (pLines, wxID_ANY, wxEmptyString, wxDefaultPosition,
                    wxDefaultSize, 0, wxDefaultValidator);
  FlexGridSizer21->Add (bLinesPenColor, 1, wxALL | wxEXPAND, 2);
  StaticText33 = new wxStaticText (pLines, wxID_ANY, _ ("Width :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer21->Add (StaticText33, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  ...
  cbLinesPenWidth
    = new wxChoice (pLines, wxID_ANY, wxDefaultPosition, wxDefaultSize, 10,
                    cbLinesPenWidth_choices, 0, wxDefaultValidator);
  cbLinesPenWidth->SetSelection (0);
  FlexGridSizer21->Add (cbLinesPenWidth, 1, wxALL | wxEXPAND, 2);
  StaticText34 = new wxStaticText (pLines, wxID_ANY, _ ("Style :"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  FlexGridSizer21->Add (StaticText34, 1,
                        wxALL | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
  const wxString cbLinesPenStyle_choices[] = {
    _ ("Solid"), _ ("Dot"), _ ("Long Dash"), _ ("Short Dash"), _ ("Dot Dash"),
  };
  cbLinesPenStyle
    = new wxChoice (pLines, wxID_ANY, wxDefaultPosition, wxDefaultSize, 5,
                    cbLinesPenStyle_choices, 0, wxDefaultValidator);
  cbLinesPenStyle->SetSelection (0);
  FlexGridSizer21->Add (cbLinesPenStyle, 1, wxALL | wxEXPAND, 2);
  StaticBoxSizer11->Add (
    FlexGridSizer21, 0,
    wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 0);
  BoxSizer18->Add (StaticBoxSizer11, 0, wxALL, 2);
  BoxSizer19 = new wxBoxSizer (wxVERTICAL);
  cbLinesVisible
    = new wxCheckBox (pLines, wxID_ANY, _ ("Visible"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbLinesVisible->SetValue (false);
  BoxSizer19->Add (cbLinesVisible, 1, wxALL | wxALIGN_LEFT, 3);
  cbLinesOutside
    = new wxCheckBox (pLines, wxID_ANY, _ ("Draw Outside Margins"),
                      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
  cbLinesOutside->SetValue (false);
  BoxSizer19->Add (cbLinesOutside, 1, wxALL | wxALIGN_LEFT, 3);
  cbLinesShowName
    = new wxCheckBox (pLines, wxID_ANY, _ ("Show name"), wxDefaultPosition,
                      wxDefaultSize, 0, wxDefaultValidator);
  cbLinesShowName->SetValue (false);
  BoxSizer19->Add (cbLinesShowName, 1, wxALL | wxALIGN_LEFT, 3);
  cbLinesSecondYAxis
    = new wxCheckBox (pLines, wxID_ANY, _ ("Use second Y axis"),
                      wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator);
  ...
  FlexGridSizer20->Add (
    BoxSizer18, 0, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL,
    5);
  ...
  bApply = new wxButton (this, wxID_ANY, _ ("Apply"), wxDefaultPosition,
                         wxDefaultSize, 0, wxDefaultValidator);
  BoxSizer2->Add (
    bApply, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 4);
  bClose = new wxButton (this, wxID_ANY, _ ("Close"), wxDefaultPosition,
                         wxDefaultSize, 0, wxDefaultValidator);
  BoxSizer2->Add (
    bClose, 1, wxALL | wxALIGN_CENTER_HORIZONTAL | wxALIGN_CENTER_VERTICAL, 4);
  sizerMain->Add (BoxSizer2, 0, wxEXPAND, 4);
  SetSizer (sizerMain);
  sizerMain->SetSizeHints (this);

  bFontTitle->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                    &MathPlotConfigDialog::OnbFontClick, this);
  bBGColor->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                  &MathPlotConfigDialog::OnbColorClick, this);
  bCoordBrushColor->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                          &MathPlotConfigDialog::OnbColorClick, this);
  bFontLegend->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                     &MathPlotConfigDialog::OnbFontClick, this);
  bLegendBrushColor->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                           &MathPlotConfigDialog::OnbColorClick, this);
  ChoiceAxis->Bind (wxEVT_COMMAND_CHOICE_SELECTED,
                    &MathPlotConfigDialog::OnAxisSelect, this);
  bAddXAxis->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                   &MathPlotConfigDialog::OnbAddAxisClick, this);
  bAddYAxis->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                   &MathPlotConfigDialog::OnbAddAxisClick, this);
  bFontAxis->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                   &MathPlotConfigDialog::OnbFontClick, this);
  bAxisPenColor->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                       &MathPlotConfigDialog::OnbColorClick, this);
  cbAutoScale->Bind (wxEVT_COMMAND_CHECKBOX_CLICKED,
                     &MathPlotConfigDialog::OncbAutoScaleClick, this);
  cbFormat->Bind (wxEVT_COMMAND_CHOICE_SELECTED,
                  &MathPlotConfigDialog::OncbFormatSelect, this);
  ChoiceSeries->Bind (wxEVT_COMMAND_CHOICE_SELECTED,
                      &MathPlotConfigDialog::OnChoiceSeries, this);
  bDelSeries->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                    &MathPlotConfigDialog::OnbDelSeriesClick, this);
  bSeriesPenColor->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                         &MathPlotConfigDialog::OnbColorClick, this);
  bSeriesBrushColor->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                           &MathPlotConfigDialog::OnbColorClick, this);
  ChoiceLines->Bind (wxEVT_COMMAND_CHOICE_SELECTED,
                     &MathPlotConfigDialog::OnChoiceLinesSelect, this);
  bAddLines->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                   &MathPlotConfigDialog::OnbAddLinesClick, this);
  bDelLines->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                   &MathPlotConfigDialog::OnbDelLinesClick, this);
  bLinesPenColor->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                        &MathPlotConfigDialog::OnbColorClick, this);
  nbConfig->Bind (wxEVT_COMMAND_NOTEBOOK_PAGE_CHANGED,
                  &MathPlotConfigDialog::OnnbConfigPageChanged, this);
  bApply->Bind (wxEVT_COMMAND_BUTTON_CLICKED,
                &MathPlotConfigDialog::OnbApplyClick, this);
  bClose->Bind (wxEVT_COMMAND_BUTTON_CLICKED, &MathPlotConfigDialog::OnQuit,
                this);
  //*)
...
void MathPlotConfigDialog::Initialize (int page)
{
  ...
  CurrentCoords
    = (mpInfoCoords *)m_plot->GetLayerByClassName (_T("mpInfoCoords"));
  if (CurrentCoords)
  {
    ...
    cbCoordBrushStyle->SetSelection (
      BrushStyleToId (CurrentCoords->GetBrush ().GetStyle ()));
  }

  // Legend page
  CurrentLegend
    = (mpInfoLegend *)m_plot->GetLayerByClassName (_T("mpInfoLegend"));
  if (CurrentLegend)
  {
    ...
    // Brush config
    DoButtonColour (bLegendBrushColor,
                    CurrentLegend->GetBrush ().GetColour ());
    cbLegendBrushStyle->SetSelection (
      BrushStyleToId (CurrentLegend->GetBrush ().GetStyle ()));
  ...
  {
    ChoiceLines->Append (
      ((mpLayer *)m_plot->GetLayersType (i, mpLAYER_LINE))->GetName ());
  }
...
void MathPlotConfigDialog::DoButtonColour (wxButton *button,
                                           const wxColour &colour)
{
  wxString RGB;
  RGB.Printf ("%02X%02X%02X", colour.GetRed (), colour.GetGreen (),
              colour.GetBlue ());
  if (colour.GetRed () * 0.299 + colour.GetGreen () * 0.587
 ...
 */
void MathPlotConfigDialog::UpdateFont (mpLayer *layer, wxButton *button,
                                       bool get_set)
{
  if (get_set)
  {
...
void MathPlotConfigDialog::SetFontChildren (wxButton *p,
...
{
  const wxString XAxis_Align[] = { _ ("Bottom border"), _ ("Bottom"),
                                   _ ("Center"), _ ("Top"), _ ("Top border") };
  const wxString YAxis_Align[] = { _ ("Left border"), _ ("Left"), _ ("Center"),
                                   _ ("Right"), _ ("Right border") };

  CurrentScale
    = (mpScale *)ChoiceAxis->GetClientData (ChoiceAxis->GetSelection ());
  //  CurrentScale =
  //  (mpScale*)m_plot->GetLayerAxis(ChoiceAxis->GetSelection());
  if (!CurrentScale)
    return;
  ...
  cbAxisPenStyle->SetSelection (CurrentScale->GetPen ().GetStyle ()
                                - wxPENSTYLE_SOLID);
...
void MathPlotConfigDialog::OnbAddAxisClick (wxCommandEvent &event)
{
  ...
  if (bt == bAddXAxis)
    newAxis = (mpScale *)new mpScaleX (wxT ("New X"), mpALIGN_CENTERX, true,
                                       mpX_NORMAL);
  else
...
void
MathPlotConfigDialog::OncbAutoScaleClick (wxCommandEvent &WXUNUSED (event))
{
...
{
  CurrentSerie
    = (mpFunction *)m_plot->GetLayerPlot (ChoiceSeries->GetSelection ());
  ...
  if (CurrentSerie)
  {
    ...
    cbSeriesPenStyle->SetSelection (CurrentSerie->GetPen ().GetStyle ()
                                    - wxPENSTYLE_SOLID);
    // Brush config
    DoButtonColour (bSeriesBrushColor, CurrentSerie->GetBrush ().GetColour ());
    cbSeriesBrushStyle->SetSelection (
      BrushStyleToId (CurrentSerie->GetBrush ().GetStyle ()));
    // Symbol config
...
void MathPlotConfigDialog::OnbDelSeriesClick (wxCommandEvent &WXUNUSED (event))
{
  ...
  {
    if (wxMessageDialog (this, MESS_DELETE, MESS_CONFIRM, wxYES_NO | wxCENTRE)
          .ShowModal ()
        == wxID_YES)
    {
...
{
  CurrentLine = (mpLine *)m_plot->GetLayersType (ChoiceLines->GetSelection (),
                                                 mpLAYER_LINE);
  ...
  if (CurrentLine)
  {
    ...
    cbLinesPenStyle->SetSelection (CurrentLine->GetPen ().GetStyle ()
                                   - wxPENSTYLE_SOLID);
...
void
MathPlotConfigDialog::OnChoiceLinesSelect (wxCommandEvent &WXUNUSED (event))
{
  UpdateSelectedLine ();
}
...
{
  int answer = wxMessageDialog (this, MESS_LINES_ADD, MESS_CONFIRM,
...
void MathPlotConfigDialog::OnbDelLinesClick (wxCommandEvent &WXUNUSED (event))
{
  if (CurrentLine)
  {
    if (wxMessageDialog (this, MESS_LINES_DELETE, MESS_CONFIRM,
                         wxYES_NO | wxCENTRE)
          .ShowModal ()
        == wxID_YES)
    {
...
void MathPlotConfigDialog::OnbApplyClick (wxCommandEvent &WXUNUSED (event))
{
  ...
  case 0: // General
  {
    ...
    if (CurrentCoords)
    {
      ...
      // Brush config
      wxBrush brush (bCoordBrushColor->GetBackgroundColour (),
                     IdToBrushStyle (cbCoordBrushStyle->GetSelection ()));
  ...
  case 1: // Legend page
    if (CurrentLegend)
    {
      CurrentLegend->SetLocation (
        (mpLocation)cbLegendPosition->GetSelection ());
      CurrentLegend->SetVisible (cbLegendVisible->GetValue ());
      CurrentLegend->SetItemMode (
        (mpLegendStyle)cbLegendStyle->GetSelection ());
      CurrentLegend->SetItemDirection (
        (mpLegendDirection)cbLegendDirection->GetSelection ());
      // Brush config
      wxBrush brush (bLegendBrushColor->GetBackgroundColour (),
                     IdToBrushStyle (cbLegendBrushStyle->GetSelection ()));
  ...
  case 2: // Axis page
    if ((CurrentChoice == ChoiceAxis) && (CurrentScale != NULL))
    {
      ...
      // Pen config
      wxPen pen (
        bAxisPenColor->GetBackgroundColour (),
        cbAxisPenWidth->GetSelection () + 1,
      ...
      ChoiceAxis->SetString (ChoiceAxis->GetCurrentSelection (),
                             newName + edAxisName->GetValue ());
  ...
  case 3: // Series page
    if ((CurrentChoice == ChoiceSeries) && (CurrentSerie != NULL))
    {
      ...
      ChoiceSeries->SetString (ChoiceSeries->GetSelection (),
                               edSeriesName->GetValue ());

      // Pen config
      wxPen pen (
        bSeriesPenColor->GetBackgroundColour (),
        cbSeriesPenWidth->GetSelection () + 1,
        (wxPenStyle)(cbSeriesPenStyle->GetSelection () + wxPENSTYLE_SOLID));
      CurrentSerie->SetPen (pen);

      // Brush config
      wxBrush brush (bSeriesBrushColor->GetBackgroundColour (),
                     IdToBrushStyle (cbSeriesBrushStyle->GetSelection ()));
  ...
  case 4: // Line page
    if ((CurrentChoice == ChoiceLines) && (CurrentLine != NULL))
    {
      ...
      ChoiceLines->SetString (ChoiceLines->GetSelection (),
                              edLinesName->GetValue ());
      edLinesValue->GetValidator ()->TransferFromWindow ();
      CurrentLine->SetValue (line_value);

      // Pen config
      wxPen pen (
        bLinesPenColor->GetBackgroundColour (),
        cbLinesPenWidth->GetSelection () + 1,
